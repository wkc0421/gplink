<template>
  ...
  >
    ...
    >
      ...
      <!-- READ_PROPERTY: select properties -->
      <a-form-item
      ...
      <!-- INVOKE_FUNCTION: select function -->
      ...
      <a-form-item label="定时规则(Cron表达式)" name="cron">
        <a-input
          ...
          placeholder="例: 0 */5 * * * ? (每5分钟)"
        />
        <div style="color: #999; font-size: 12px; margin-top: 4px">
          支持标准Cron表达式,如: 0 0/1 * * * ? 表示每分钟执行一次
        </div>
      </a-form-item>
...
// Called when user manually picks a different product — clear dependent selections.
